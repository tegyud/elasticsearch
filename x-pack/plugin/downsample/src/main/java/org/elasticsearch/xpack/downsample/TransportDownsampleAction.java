            ...
            taskQueue.submitTask(
                ...
                new DownsampleClusterStateUpdateTask(
                    ...
                    public ClusterState execute(ClusterState currentState) {
                        final ProjectMetadata metadata = currentState.metadata().getProject(projectId);
                        ...
                        final ProjectMetadata.Builder metadataBuilder = ProjectMetadata.builder(metadata);
                        ...
                        return ClusterState.builder(currentState).putProjectMetadata(metadataBuilder).build();
                    }
                },
                timeout
            );
